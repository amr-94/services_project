...
<head>
    <meta charset="utf-8">
    <title>Amr - Elctronics Repair Services</title>
    ...
    <div id="layout" >
        <div class="info-head"  >
            <div class="container">
                <div class="row">
                    <div class="col-md-6" >
                        @livewire('testcontact')

                    </div>
                    @livewire('locationcomponent')
        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                            ...
                            <li class="login-form"> <a href="#" title="Register">my account (admin)</a>
                                    <ul class="drop-down one-column hover-fade">
                                             <li><a href="{{route('admin.dashbord')}}">Dashboard</a></li>
                                              <li><a href="{{route('admin.service_categories')}}">service catigories</a></li>
                                              <li><a href="{{route('admin.all_services')}}">All services </a></li>
                                               <li><a href="{{route('admin.slider')}}">Manage Slider </a></li>
                                             <li><a href="{{route('admin.contact_us')}}">Contact Profile</a></li>
                                             <li><a href="{{route('admin.service_provider')}}">Show All providers</a></li>
                                              <li><a href="{{route('admin.profile')}}">Show Admin profile</a></li>
                  ...
                  {{--+_____ _ _ _ _ _ _ _ _______________ notification  ________________________________--}}
                            <li class="login-form"> <a href="#" title="Register">Notifications</a>
                                    <ul class="drop-down one-column hover-fade">
                                             <li style="  font-weight: bold;"> عدد الاشعارات الغير مقروءة :<h3  style="color: rgb(241, 23, 23)" id="notifications_count">
                                                   ...
                                                   <li>
                                                      ...
                                                      <p style=" font-weight: bold;text-align: center"> {{ $notification->data['title'] }} : </p>
                                                        <p ><h6 style="color: rgb(255, 0, 0);text-align: center">
                                                        {{ $notification->data['user'] }}</h6></p>
                          ...
                          <li class="login-form"> <a href="{{ route ('register')}}" title="Register">my account (S provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                                             <li><a href="{{route('provider.dashbord')}}">Dashboard</a></li>
                                              <li><a href="{{route('sproviser.add_service')}}">Add services </a></li>
                                             <li><a href="{{route('Sprovider.profile')}}">Sprovider Profile</a></li>
                          ...
                          @else
                           <li class="login-form"> <a href="{{route ('register')}}" title="Register">my account (customer)</a>
                                    <ul class="drop-down one-column hover-fade">
                                             <li><a href="{{route('customer.dashbord')}}">Dashboard</a></li>
            ...
            <div class="container">
                <div class="row visible-md visible-lg">
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/12.html')}}">TV</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/14.html')}}">Geyser</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/13.html')}}">Refrigerator</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/21.html')}}">Washing Machine</a>
                            </li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/22.html')}}">Microwave Oven</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/10.html')}}">Water Purifier</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>AC SERVICES </h3>
                        <ul>
                            ...
                            <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-repair.html')}}">AC Repair</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-gas-refill.html')}}">Gas Refill</a>
                            </li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-wet-servicing.html')}}">Wet
                                    Servicing</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('service-details/ac-dry-servicing.html')}}">Dry
                                    Servicing </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>HOME NEEDS </h3>
                        <ul>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/19.html')}}">Laundry </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/4.html')}}">Electrical</a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/8.html')}}">Pest Control </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/7.html')}}">Carpentry </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/3.html')}}">Plumbing </a></li>
                            <li><i class="fa fa-check"></i> <a href="{{ asset('servicesbycategory/20.html')}}">Painting </a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        <h3>CONTACT US</h3>
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:lost_angel51@yahoo.com">lost_angel51@yahoo.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:01032961547">01032961547</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:01032961547">01032961547</a>
                            </li>
                        </ul>
