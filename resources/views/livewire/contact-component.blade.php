                            ...
                            <div class="col-md-4">
                                <aside>
                                   ...
                                   @foreach ( $admin as $admin )
                                    ...
                                    <address>
                                        <strong>{{ $admin->name }} Services Home Services.</strong><br>
                                        <i class="fa fa-map-marker"></i><strong>Address: </strong>cairo,eg
                                        <br>
                                        <i class="fa fa-phone"></i><strong>Phone: </strong> {{ $admin->phone }}
                                    </address>
                                    @endforeach
                                    <address>
                                        <strong>Amr Services Emails</strong><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:contact@surfsidemedia.in"> {{ $admin->email }}</a><br>
                                    </address>
                                </aside>
                                <hr class="tall">
                            </div>
