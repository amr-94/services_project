            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                        ...
                        <img src="{{ asset('images/slider')}}/{{ $slide->image }}" alt="{{ $slide->titel }}" data-bgposition="center center"
            ...
            <div class="content_info">
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="titles">
                                <h2>WE <span>Choice</span> this Services for you</h2>
                        ...
                        <div class="portfolioContainer" style="margin-top: -50px;">
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{ route('home.service_details',['service_slug'=>$featured->slug])}}">
                                    <div class="img-hover">
                                        <img src="{{ asset('images/services/thumbnails')}}/{{$featured->thumbnail  }}" alt="{{$featured->name  }}"
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="content-btn"><a href="{{ route('home.service_details',['service_slug'=>$featured->slug])}}"
                                                class="btn btn-primary">Book Now</a></div>
                                        <div class="price"><span>&#36;</span><b>From</b>{{$featured->price}}</div>
                                    </div>
                                </a>
                            </div>
                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-4 ">
                                <div class="services-lines-info">
                                    ...
                                    <p class="lead">
                                        Choose best services at one place.
                                        <span class="line"></span>
                                    </p>

                                    <p>This is Avavile Service</p>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <ul class="services-lines">
                                    @foreach ($featuredcat as $featuredcat )


                                    <li>
                                        <a href="{{ route('home.services_by_category',['category_slug'=>$featuredcat->slug])}}">
                                            <div class="item-service-line">
                                                <i class="fa"><img class="icon-img"
                                                        src="{{ asset('images/categories')}}/{{ $featuredcat->image }}"></i>
                                                <h5>{{ $featuredcat->name }}</h5>
                                            </div>
                                        </a>
                                    </li>
                                     @endforeach
