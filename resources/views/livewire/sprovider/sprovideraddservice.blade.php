                                        ...
                                        <form class="form-horizontal" wire:submit.prevent="createService">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                     <label for="provider" class="control-label col-sm-3"> provider name :</label>
                                                     <div class="col-sm-9">
                                                         <select class="form-control" wire:model="users_id">
                                                             ...
                                                             @error('users_id') <p class="text-danger">{{ $message }}</p> @enderror
                                                        </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <div class="col-sm-9">
                                                         <select name="discount_type" id="" class="form-control" model:wire="discount_type">
                                                             <option value="">Select Service Category</option>
