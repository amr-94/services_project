                            ...
                            <div class=" col-md-12 profile1">
                               <div class="panel panel-default">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-md-6">
                                          <a href="{{ route('admin.add_slide') }}" class="btn btn-info pull-right">add new service</a>
                                            ...
                                            <tr>
                                               ...
                                               <td> {{ $slide->created_at->diffForHumans() }} </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" onclick="confirm('are you sure, you want to delete this slide ?')||event.stopImmediatePropagation()" wire:click.pervent="deleteslide({{ $slide->id }})" style="margin-left: 20px">
