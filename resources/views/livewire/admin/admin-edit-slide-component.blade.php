                            ...
                            <div class=" col-md-8 col-md-offset-2 profile1">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="row">
                                              <div class="col-md-6">
                                               ...
                                               <div class="col-md-6">
                                                    <a href="{{ route('admin.slider') }}" class="btn btn-info pull-right">All Slide</a>
                                                </div>
                                        </div>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" wire:submit.prevent="updateslides" enctype="multipart/form-data>
                                            @csrf
                                            <div class="form-group">
                                                <label for="title" class="control-label col-sm-3">Title</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" title="title" wire:model="title" />
