                        ...
                        <ul class="services-lines full-services">
                            @foreach ( $catagories as $catagories )
                                ...
                                <div class="item-service-line">
                                    <i class="fa"><a href="{{ route('home.services_by_category',['category_slug'=>$catagories->slug]) }}"><img class="icon-img"
                                         src="{{ asset('images/categories') }}/{{ $catagories->image }}" alt="AC"></a></i>
